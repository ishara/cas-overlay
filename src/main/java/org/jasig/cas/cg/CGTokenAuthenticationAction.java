...
/**
 * This class represents an action in the webflow to retrieve
 ...
 */
@Component("cgTokenAuthenticationAction")
public final class CGTokenAuthenticationAction extends AbstractAction
{
    private static final Logger LOGGER = LoggerFactory.getLogger( CGTokenAuthenticationAction.class );
    ...
    protected Event doExecute( final RequestContext context ) throws Exception
    {
        ...
        {
            authTokenValue = request.getParameter( "z" );
        }
